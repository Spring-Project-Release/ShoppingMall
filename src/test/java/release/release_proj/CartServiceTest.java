...
public class CartServiceTest {
    ...
    public void 유저_장바구니_전체_결제() throws Exception {
        ...
        // Then
        assertThat(!orderRepository.findByBuyerId(memberId, 0, 20).isEmpty());
        assertEquals(orderRepository.findByBuyerId(memberId, 0, 20).size(), 2);
        assertThat(orderRepository.findByBuyerId(memberId, 0, 20).get(0).getItemId()).isEqualTo(item1.getItemId());
        assertThat(orderRepository.findByBuyerId(memberId, 0, 20).get(1).getItemId()).isEqualTo(item2.getItemId());
        assertThat(orderRepository.findByBuyerId(memberId, 0, 20).get(0).getMemo()).isEqualTo("전체결제");
        assertThat(orderRepository.findByBuyerId(memberId, 0, 20).get(1).getMemo()).isEqualTo("전체결제");
    ...
    public void 유저_장바구니_일부_결제() throws Exception {
        ...
        // Then
        assertThat(!orderRepository.findByBuyerId(memberId, 0, 20).isEmpty());
        assertEquals(orderRepository.findByBuyerId(memberId, 0, 20).size(), 1);
        assertThat(orderRepository.findByBuyerId(memberId, 0, 20).get(0).getItemId()).isEqualTo(item1.getItemId());
        assertThat(orderRepository.findByBuyerId(memberId, 0, 20).get(0).getMemo()).isEqualTo("일부결제");
